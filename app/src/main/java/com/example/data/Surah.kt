...
object SurahData {
    val surahsList = listOf(
        Surah(1, "الفاتحة", "Al-Fatiha", "The Opening", 7, "Meccan"),
        Surah(2, "البقرة", "Al-Baqarah", "The Cow", 286, "Medinan"),
        Surah(3, "آل عمران", "Aal-Imran", "The Family of Imran", 200, "Medinan"),
        ...
        Surah(76, "الإنسان", "Al-Insan", "The Man", 31, "Medinan"),
        ...
        Surah(101, "القارعة", "Al-Qariah", "The Calamity", 11, "Meccan"),
